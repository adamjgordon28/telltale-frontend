...
const emptyContent =
    '{"blocks":[{"key":"dpilv","text":"","type":"unstyled","depth":0,"inlineStyleRanges":[],"entityRanges":[],"data":{}}],"entityMap":{}}'
...
export default HOCWithAuth(
    connect(mapStateToProps, mapDispatchToProps)(CreateEntryForm)
)
