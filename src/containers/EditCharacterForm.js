...
class EditCharacterForm extends Component {
    ...
    deleteCharacter = () => {
        fetch(
            ...
            .then((character) => {
                ...
                this.state.character.character_settings.forEach(
                    (character_setting) => {
    ...
    render() {
        if (
            ...
            if (
                this.props.currentUser.id !== this.state.character.entry.user_id
            ) {
...
function mapDispatchToProps(dispatch) {
    return {
        ...
        updateCharacterInEntry: (character) => {
            dispatch({
                type: 'UPDATE_CHARACTER_IN_ENTRY',
                payload: character,
            })
        },
        removeCharacterFromEntry: (character) => {
            dispatch({
                type: 'REMOVE_CHARACTER_FROM_ENTRY',
                payload: character,
            })
        },
...
export default HOCWithAuth(
    connect(mapStateToProps, mapDispatchToProps)(EditCharacterForm)
)
