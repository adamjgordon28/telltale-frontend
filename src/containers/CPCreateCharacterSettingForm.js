...
class CPCreateCharacterSettingForm extends Component {
    ...
    renderRows = () => {
        if (this.props.currentEntry) {
            const sortedSettings = this.props.currentEntry.settings.sort(
                function (a, b) {
            ...
            const settingOptionsArray = sortedSettings.map((setting) => {
                return (
            ...
            >
                ...
                >
                    <h3 style={{ textAlign: 'center' }}>
                        Where does {this.props.character.name} appear in your
                        story? Detail it here!
                    </h3>
                </div>
                {this.props.currentEntry.settings.length ? (
                    ...
                    <h3 style={{ textAlign: 'center', margin: '5%' }}>
                        No settings have been detailed yet for this entry. If
