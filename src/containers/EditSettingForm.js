...
class EditSettingForm extends Component {
    ...
    deleteSetting = () => {
        fetch(
            ...
            .then((setting) => {
                ...
                this.state.setting.character_settings.forEach(
                    (character_setting) => {
                        this.props.removeCharacterSettingFromEntry(
                            character_setting
                        )
                    }
                )
    ...
    render() {
        if (
            ...
            if (
                this.props.currentUser.id !== this.state.setting.entry.user_id
            ) {
                            ...
                            <div style={{ position: 'absolute', left: '39%' }}>
                                ...
                                <button
                                    ...
                                    onClick={(e) => {
                                        if (
                                            window.confirm(
                                                'Are you sure you wish to delete this setting? This cannot be undone.'
                                            )
                                        )
                                            this.deleteSetting(e)
                                    }}
...
export default HOCWithAuth(
    connect(mapStateToProps, mapDispatchToProps)(EditSettingForm)
)
