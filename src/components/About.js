...
render(){
  return (
    <div className="ui raised card" style={{width:"56%", minWidth:"50em", position:"relative", left:"22%", padding:"3em", top:"1em", height:"35em"}}>
      ...
      <h3 style={{color:"black", textAlign: "center"}}>We here at TellTale appreciate the fun and importance of writing, but also know that it can sometimes be difficult to know where to start. Have an idea for a story? Once you're logged in you can click the "Start a New Entry" button and jot down some quick notes. Each entry comes with its own storyboard, where you can feel free to add characters and settings, and even detail characters at certain settings during particular chapters. The way you choose to organize the story is up to you! Each entry also includes its own text editor, and your entry will always be there waiting for you without having to save. You can follow other authors and read their entries as well. What are you waiting for? Get writing! </h3>
      </div>
    </div>
  )
}
