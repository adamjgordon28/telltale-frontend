...
class EntryCard extends React.Component {
  ...
  <div className="content">
    <div className="header"><span style={{display:"inline-block", maxWidth:"20em", overflowX:"hidden", height:"1.25em", whiteSpace:"no-wrap", textOverflow:"ellipsis", position:"relative", top:".25em"}}>{this.props.entry.title.concat("    ")}</span> <span style={{display:"inline-block", position:"relative", marginLeft:"1em", fontSize:".75em", color: "gray"}}> ({this.props.entry.genre})</span>
  ...
  <div style={{position:"absolute", right: ".00001%", bottom: "22.5%", maxHeight: "55%", minHeight: "55%", overflowY: "scroll", width: "100%", padding:"1%"}} className="description">
    <h4 style={{position:"relative", left:"1.625%", color:"black", top:".25em"}}>by {this.props.entry.user.username}</h4>
