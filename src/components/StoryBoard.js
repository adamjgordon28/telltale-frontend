        ...
        if (!this.props.currentUser || !this.props.currentEntry) {
            ...
            if (this.props.currentUser.id !== this.props.currentEntry.user.id) {
                ...
                return (
                    ...
                    >
                        <h1>
                            Storyboard for "{this.props.currentEntry.title}"{' '}
                            <span style={{ color: 'gray' }}>
                                (
                                {this.props.currentEntry.published
                                    ? 'Published'
                                    : 'Not Published'}
                                )
                            </span>
                        ...
                        <div style={{ width: '100%', position: 'relative' }}>
                            <StoryBoardSettingList
                                entry={this.props.currentEntry}
                            />
                            <StoryBoardCharacterList
                                entry={this.props.currentEntry}
                            />
                            <StoryBoardCharacterSettingList
                                entry={this.props.currentEntry}
                            />
                        </div>
                        <div style={{ position: 'relative', left: '55%' }}>
                            ...
                            >
                                <button
                                    ...
                                    style={{ marginRight: '5%' }}
                                >
                                    Add a Character or Setting!
                                </button>
                            </Link>
                            <Link
                                to={`/edit-entry/${this.props.currentEntry.id}`}
                            >
                                <button
                            ...
                            <Link
                                key={Math.random()}
                                to={`/entries/${this.props.currentEntry.id}`}
                            >
                                <button
